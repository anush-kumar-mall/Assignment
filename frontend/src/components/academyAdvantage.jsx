...
export default function UpcomingWorkshops() {
  ...
  return (
    <section className="w-full bg-[linear-gradient(135deg,#1D3FFF_0%,#040C82_100%)] text-white py-16 font-inter">
      
      {/* ✅ MAX WIDTH + BREATHING SPACE WRAPPER */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          {workshops.map((workshop) => (
            <motion.div
              ...
              className="bg-white text-gray-800 rounded-2xl flex flex-col overflow-hidden cursor-pointer"
            >
              {/* Thumbnail */}
              <div
        ...
        <button
          ...
          className="mt-12 bg-white text-blue-600 font-semibold px-6 py-3 rounded-lg shadow hover:bg-blue-50 transition"
        >
